...
public class BoardMainEX1 {
	...
	private static int boardNum = 1;// 추가될 게시글 번호 (중간 글이 삭제되어도 유지되게하는 변수)
	...
	*/
	...
	private static void delList () {
		...
		Board tmpArr[] = new Board [boardList.length];
		System.arraycopy(boardList, 0, tmpArr, 0, boardList.length);
		System.arraycopy(tmpArr, index+1, boardList, index, count-index);
	}
